...
prior = {
    ...
    'delta_E': np.array(['0.4(3)', '0.7(3.2)', '1.1(3.2)', '1.3(3.2)'], dtype=object),
    ...
    'xi_st_z_PS': np.array(['0.0(3.3)e-04', '0.0(3.3)e-04', '0.0(3.3)e-08', '0.0(3.3)e-08'],dtype=object),
    'xi_st_z_SS': np.array(['0.0(3.3)e-04', '0.0(3.3)e-04', '0.0(3.3)e-04', '0.0(3.3)e-04'],dtype=object),
    'xi_z_PS': np.array(['0.0(3.3)e-04', '0.0(3.3)e-04', '0.0(3.3)e-08', '0.0(3.3)e-08'],dtype=object),
