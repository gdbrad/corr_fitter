...
prior = gv.BufferDict()
prior = {
    'sigma_E': np.array(['0.68(2)', '0.8(3.2)', '0.9(3.2)', '1.0(3.2)'], dtype=object),
    'sigma_z_PS': np.array(['0.0(3.3)e-06', '0.0(3.3)e-06', '0.0(3.3)e-06', '0.0(3.3)e-06'],dtype=object),
    'sigma_z_SS': np.array(['4.4(4.4)e-06', '4.4(4.4)e-06', '4.4(4.4)e-06', '4.4(4.4)e-06'],dtype=object),
    'sigma_st_E': np.array(['0.8(3)', '0.9(32)', '1.0(3.2)', '1.1(3.2)'], dtype=object),
    ...
    'lam_E': np.array(['0.64(2)', '0.9(3.2)', '1.1(3.2)', '1.3(3.2)'], dtype=object),
    ...
    'proton_E': np.array(['0.61(2)', '0.9(2.2)', '1.0(2.2)', '1.1(2.2)'], dtype=object),
    'proton_z_PS': np.array(['0.0(3.3)e-05', '0.0(3.3)e-05', '0.0(3.3)e-05', '0.0(3.3)e-05'],dtype=object),
